...
use Tests\StaticConstructor\StaticConstructorLoaderState;
use Tests\StaticConstructor\Stubs\SingletonStub;
...
test('throws when zero autoloaders are registered', function () {
	...
	StaticConstructorLoaderRegisterer::register();
})->skip()->expectExceptionObject(new StaticConstructorInvalidUsageException('Composer\Autoload\ClassLoader was not found in registered autoloaders'));
...
test('calls static constructor', function () {
	expect(class_exists(SingletonStub::class, false))->toBeFalse();
